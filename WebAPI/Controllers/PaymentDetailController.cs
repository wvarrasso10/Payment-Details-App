...
namespace WebAPI.Controllers
{
    ...
    public class PaymentDetailController : ControllerBase
    {
        ...
        // returns collection of payment details in payment detail table
        ...
        // updates payment detailsfor a specific id
        ...
        // DELETE: api/PaymentDetail/5 delete method for http
        [HttpDelete("{id}")]
